...
std::string ToString(const VkResult inEnum) {
    switch (inEnum) {
        ...
        default:
            return "Non existent VkResult value";
    }
}
...
std::string ToString(const VkFormat inEnum) {
    switch (inEnum) {
        ...
        default:
            return "None existent VkFormate Value";
    }
}
...
std::string ToString(VkShaderStageFlagBits inEnum) {
    ...
    if (CheckFlag(inEnum, VK_SHADER_STAGE_TESSELLATION_CONTROL_BIT)) {
        result += "VK_SHADER_STAGE_TESSELLATION_CONTROL_BIT | ";
    }

    if (CheckFlag(inEnum, VK_SHADER_STAGE_TESSELLATION_EVALUATION_BIT)) {
        result += "VK_SHADER_STAGE_TESSELLATION_EVALUATION_BIT | ";
    }

    if (CheckFlag(inEnum, VK_SHADER_STAGE_GEOMETRY_BIT)) {
        result += "VK_SHADER_STAGE_GEOMETRY_BIT | ";
    }

    if (CheckFlag(inEnum, VK_SHADER_STAGE_FRAGMENT_BIT)) {
        result += "VK_SHADER_STAGE_FRAGMENT_BIT | ";
    }

    if (CheckFlag(inEnum, VK_SHADER_STAGE_COMPUTE_BIT)) {
        result += "VK_SHADER_STAGE_COMPUTE_BIT | ";
    }

    if (CheckAllFlag(inEnum, VK_SHADER_STAGE_ALL_GRAPHICS)) {
        result += "VK_SHADER_STAGE_ALL_GRAPHICS";
        return result;
    }

    if (CheckAllFlag(inEnum, VK_SHADER_STAGE_ALL)) {
        result += "VK_SHADER_STAGE_ALL";
        return result;
    }

    if (CheckFlag(inEnum, VK_SHADER_STAGE_RAYGEN_BIT_KHR)) {
        result += "VK_SHADER_STAGE_RAYGEN_BIT_KHR | ";
    }

    if (CheckFlag(inEnum, VK_SHADER_STAGE_ANY_HIT_BIT_KHR)) {
        result += "VK_SHADER_STAGE_ANY_HIT_BIT_KHR | ";
    }

    if (CheckFlag(inEnum, VK_SHADER_STAGE_CLOSEST_HIT_BIT_KHR)) {
        result += "VK_SHADER_STAGE_CLOSEST_HIT_BIT_KHR | ";
    }

    if (CheckFlag(inEnum, VK_SHADER_STAGE_MISS_BIT_KHR)) {
        result += "VK_SHADER_STAGE_MISS_BIT_KHR | ";
    }

    if (CheckFlag(inEnum, VK_SHADER_STAGE_INTERSECTION_BIT_KHR)) {
        result += "VK_SHADER_STAGE_INTERSECTION_BIT_KHR | ";
    }

    if (CheckFlag(inEnum, VK_SHADER_STAGE_CALLABLE_BIT_KHR)) {
        result += "VK_SHADER_STAGE_CALLABLE_BIT_KHR | ";
    }

    if (CheckFlag(inEnum, VK_SHADER_STAGE_TASK_BIT_EXT)) {
        result += "VK_SHADER_STAGE_TASK_BIT_EXT | ";
    }

    if (CheckFlag(inEnum, VK_SHADER_STAGE_MESH_BIT_EXT)) {
        result += "VK_SHADER_STAGE_MESH_BIT_EXT | ";
    }

    if (CheckFlag(inEnum, VK_SHADER_STAGE_SUBPASS_SHADING_BIT_HUAWEI)) {
        result += "VK_SHADER_STAGE_SUBPASS_SHADING_BIT_HUAWEI | ";
    }

    if (CheckFlag(inEnum, VK_SHADER_STAGE_CLUSTER_CULLING_BIT_HUAWEI)) {
        result += "VK_SHADER_STAGE_CLUSTER_CULLING_BIT_HUAWEI | ";
    }

    if (CheckAllFlag(inEnum, VK_SHADER_STAGE_FLAG_BITS_MAX_ENUM)) {
        result += "VK_SHADER_STAGE_FLAG_BITS_MAX_ENUM";
        return result;
    }
...
std::string ToString(const VkColorSpaceKHR inEnum) {
    switch (inEnum) {
        ...
        default:
            return "None existent VkColorSpaceKHR Value";
    }
}
...
std::string ToString(const VkPresentModeKHR inEnum) {
    switch (inEnum) {
        ...
        default:
            return "None existent VkPresentModeKHR Value";
    }
}
#endif
